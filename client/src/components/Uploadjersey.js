...
import { renderUploadImage } from '../components/Imagecompressor';



class Uploadjersey extends Component {
  constructor (props){
    super(props);
  ...
  render() {
    return (
        ...
        // <img className="downloadLogo" src={require('./images/crickethomehelmet.jpg')}/>
